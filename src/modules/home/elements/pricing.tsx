...
const Pricing = () => {
  ...
  return (
    <div className="w-full bg-[#e8e8d2]">
      <div className="w-[95%] m-auto py-5">
        <div className="w-full md:flex justify-between">
          <div>
            <h3 className="font-clashDisplay text-center lg:text-left uppercase text-cyber-ink text-[2.75rem] md:text-5xl lg:text-[4rem] xl:text-[5.75rem] max-w-4xl">
              Pricing
            </h3>

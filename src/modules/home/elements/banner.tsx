  ...
  return (
    <div className="bg-[#f7f5ff] h-[95vh]">
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
        <Image
          src={
            //when you are using any image from any domain , you have to first config that domain in next.congig.mjs , other wise it will give error
        ...
        <div className="absolute">
          <h1 className="font-clashDisplay uppercase font-bold text-cyber-ink text-[2.75rem] md:text-[7xl] lg:text-[4rem] xl:text-[5.75rem] max-w-4xl mx-auto text-center z-10 leading-tight">
          Accelerate Your Growth with Every
            <span className="font-style">UPDATE</span>
          </h1>
          <br />
